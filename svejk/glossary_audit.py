...
JARGON_SEEDS: tuple[str, ...] = (
    ...
    r"pozměňovací návrh",
    r"procedurální návrh",
    r"přerušení (?:schůze|jednání|bodu)",
    r"vrácen(?:o|ý|á) senátem",
    r"vrátil senát",
    r"fiskální pravidl",
    r"rozpočtov(?:é|ých) brzd",
    r"harmonizac",
    r"lex developer",
    r"EET",
    ...
    r"penzijní spoření",
    r"investiční fond",
    r"státní vyznamenání",
    r"kvorum",
    r"kontaktní místo obce",
    r"podpoře bydlení",
    r"Rada ČT",
    r"Úřad práce",
    r"sudetoněmecký landsmanšaft",
    r"usnesení(?:m|mi)?",
    r"tajné hlasování",
    r"tajnou volbu",
    r"volební komis",
    ...
    r"životní minimum",
    r"superdávk",
    r"digitalizac(?:i|e) dávek",
    r"Benešov(?:y|ých) dekret",
    r"koncesionářsk",
    r"třetí pilíř",
    r"důchodov(?:ý|ého) třetí pilíř",
    r"minimální sociální záloh",
    r"veřejnoprávní média",
    r"landsmanšaft",
    r"sudetoněmeck",
    r"volb(?:a|ě) rady ČT",
    r"rezerv(?:y|ami) VZP",
    ...
    r"transpozic",
    r"schodek",
    r"rozpočtov(?:é|ého) pravidl",
    r"poslaneck(?:ý|ých|é) klub",
    r"\bvýbor",
    r"imunit(?:a|u)",
    r"nařízení EU",
    r"eLegislativa",
    ...
    r"Ústava",
    r"Ústavní soud",
    r"kupónov(?:á|ou) privatizac",
    r"správní rad(?:a|y) VZP",
    r"sbír(?:ka|ce) zákon",
    r"legislativní proces",
    r"služební zákon",
    r"stenoprotokol",
    r"organizační výbor",
    r"tajná volba",
    r"místopředsed(?:kyně|ce|a) [Ss]němovn",
)
...
FALSE_POSITIVE = re.compile(
    r"(?:vzpome|senátor|senátore|senátní|nedůvěry|nedůvěryhod|zpravodajsk|zpravodajstv|Výborn)",
    re.I,
)
