...
# po syncu — compose jen schůze, které se reálně změnily
./run-svejk.sh compose-changed --obdobi 2025
...
`review` ukáže návrhy vět ze stena a náhled závěru dne. **Curiosity pass** (procházka `steno.jsonl` pro scény, spory a citace mimo automatiku) je v [WORKFLOW.md](WORKFLOW.md) §2a. Před publikací **finální průchod celého vydáním** (doplnit linky, ověřit fakta): §9.
